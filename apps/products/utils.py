...
from .pagination import PAGINATION_PARAMS, PRODUCT_PAGINATION_PARAMS, HOMEPAGE_PAGINATION_PARAMS
...
def swagger_helper(tags, model):
    def decorators(func):
        ...
        if model == "Product" and action_type == "list":
        ...
        if model == "Product" and action_type == "homepage":
            return swagger_auto_schema(manual_parameters=HOMEPAGE_PAGINATION_PARAMS, operation_id=f"{action_type} {model}", operation_description=get_description, tags=[tags])(func)
